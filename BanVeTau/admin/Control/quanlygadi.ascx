<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="quanlygadi.ascx.cs" Inherits="BanVeTau.admin.Control.quanlygadi" %>
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Quản lý ga đi</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<!-- /.row -->
        ...
        <ContentTemplate>
            ...
            <div class="col-lg-12">
                <div class="table-responsive">
                    <asp:GridView runat="server" ID="gv_gadi" CssClass="table"
